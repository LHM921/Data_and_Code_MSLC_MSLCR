...
var.name = set
Xlab = as.list(p)
Xlab[[1]] = seq(-89,100.5,39)
Xlab[[2]] = seq(-15,70.5,20)
...
SigN = estNC$para$Sigma
 ...
 for(i in 2){
  ...
  contour(x1, x2, den, labcex = 0.3, add=T, lty=1, col="deeppink2", lwd=0.4, drawlabels = T, levels=c(0.00035,0.00009,0.00001,0.000002))
  contour(x1, x2, denN, labcex = 0.3, add=T, lty=2, col="blue", lwd=0.5, drawlabels = T, levels=c(0.00035,0.00009,0.00001,0.000002))
 } 
 ...
 denN = matrix(denN, m, m)
 contour(x1, x2, den, labcex = 0.3, add=T, lty=1, col="deeppink2", lwd=0.4, drawlabels = T, levels=c(0.00005,0.00003,0.000009,0.000001,0.00000025))
 contour(x1, x2, denN, labcex = 0.3, add=T, lty=2, col="blue", lwd=0.5, drawlabels = T, levels=c(0.00005,0.00003,0.000009,0.000001,0.00000025))
...
# ----------
 ...
 denN = matrix(denN, m, m)
 contour(x1, x2, den, labcex = 0.3, add=T, lty=1, col="deeppink2", lwd=0.4, drawlabels = T, levels=c(0.00008,0.00003,0.00001,0.000003,0.0000004))
 contour(x1, x2, denN, labcex = 0.3, add=T, lty=2, col="blue", lwd=0.5, drawlabels = T, levels=c(0.00008,0.00003,0.00001,0.000003,0.0000004))
